...
Las intensidades de piel / maquillaje son `[0.0, 1.0]`. `0` desactiva. El remodelado es **`[-1.0, 1.0]`**. Listas completas de enumeraciones: [Enumeraciones de parámetros](/es/intro/makeup).
