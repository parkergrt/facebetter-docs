...
<Note>
SDK **2.0.0**. Headers live in `facebetter/*.h`. Makeup / reshape / style enums: [Parameter enums](/intro/makeup). Auth: [License & Auth](/intro/license).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="FAQ" href="/windows/faq">Common integration questions</Card>
</CardGroup>
