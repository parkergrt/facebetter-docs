...
<Note>
SDK **2.0.0**. Namespace `facebetter`. Headers: `facebetter/beauty_effect_engine.h`, `beauty_params.h`, `image_frame.h`, `type_defines.h`. Style / color / reshape enums: [Parameter enums](/intro/makeup). Auth: [License & Auth](/intro/license). Linux uses the **same** C++ API.
</Note>
