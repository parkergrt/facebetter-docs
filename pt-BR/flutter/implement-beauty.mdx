...
| `enableLandmarks` | `false` | No nível do mecanismo; não dá para mudar depois. Flutter não tem callback de landmarks — mantenha `false` |
...
Remodelagem corporal **`[0.0, 1.0]`**. Registre `resource_body.fbd` primeiro. Veja [Enums de parâmetros](/pt-BR/intro/makeup) e [Pacotes de recursos opcionais](/pt-BR/intro/resource-packs):
