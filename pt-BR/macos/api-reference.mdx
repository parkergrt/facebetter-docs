...
description: "API Objective-C macOS do Facebetter SDK 2.0"
---
...
iOS e macOS compartilham esta API Objective-C. Somente macOS: `+[FBImageFrame createWithNSImage:]`. SO mínimo: **macOS 10.15**, arquiteturas **x86_64** e **arm64**. Use AppKit (`NSImage`) para stills.
...
| `addResourcePack:` | Caminho do pacote extra de capacidade (por exemplo `resource_3d.fbd` antes de `set3DSticker:`) |
