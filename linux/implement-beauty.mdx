...
<Note>
SDK **2.0.0**. Same C++ API as Windows (`facebetter` namespace). Enums: [Parameter enums](/intro/makeup). Auth: [Auth & License](/intro/license).
</Note>
...
Skin / makeup / body reshape `[0.0, 1.0]`. Face reshape **`[-1.0, 1.0]`**. Body reshape needs `resource_body.fbd`. Full enums: [Parameter enums](/intro/makeup). Packs: [Optional resource packs](/intro/resource-packs).
...
For TRTC / Agora / LiveKit: [Third-party Integration](/linux/third-party-integration).

## Related

<CardGroup cols={2}>
  <Card title="Third-party Integration" href="/linux/third-party-integration">TRTC / Agora / LiveKit</Card>
