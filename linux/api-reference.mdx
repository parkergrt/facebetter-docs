...
<Note>
SDK **2.0.0**. Namespace `facebetter`. Same public C++ API as [Windows](/windows/api-reference). Headers: `facebetter/*.h`. Enums: [Parameter enums](/intro/makeup). Auth: [License & Auth](/intro/license).
</Note>
