...
Bind the macOS Bundle ID, then pass either `licenseToken` or `appId` + `appKey`. See [Get AppID and AppKey](/intro/enable-service#get-appid-and-appkey) and [License & Auth](/intro/license).
