...
<Note>
本文档对应 SDK **2.0.0**。类名：**`FBEngine`**。美妆 / 美型枚举：[参数枚举](/zh/intro/makeup)。鉴权：[授权与许可证](/zh/intro/license)。
</Note>
...
要求 `externalContext: false`，否则抛 `StateError`。**不要用于 TRTC 视频。**
