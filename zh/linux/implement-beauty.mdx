...
皮肤 / 美妆 / 美体 `[0.0, 1.0]`。美型 **`[-1.0, 1.0]`**。美体需要 `resource_body.fbd`。完整枚举见 [参数枚举](/zh/intro/makeup)，资源包见 [可选资源包](/zh/intro/resource-packs)。
...
engine->AddResourcePack("resource/resource_body.fbd");  // 或与 resource.fbd 同目录
